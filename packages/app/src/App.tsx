      ...
      {Platform.OS !== "web" && (
        <MobileRoute.Router>
          <MobileRoute.Routes>
            ...
            <MobileRoute.Route
              path="/viewCollective"
              element={<ViewCollectivePage />}
            />
            <MobileRoute.Route
              path="/viewStewards"
              element={<ViewStewardsPage />}
            />
            <MobileRoute.Route
              path="/viewDonors"
              element={<ViewDonorsPage />}
            />
            <MobileRoute.Route
              path="/walletProfile"
              element={<WalletProfilePage />}
            />
            <MobileRoute.Route
              path="/walletProfileSteward"
              element={<WalletProfilePageSteward />}
            />
            <MobileRoute.Route
              path="/walletProfileDonor"
              element={<WalletProfilePageDonor />}
            />
            <MobileRoute.Route
              path="/activityLog"
            ...
            <MobileRoute.Route
              path="/walletEmpty"
              element={<WalletProfilePageEmpty />}
            />

  ...
  return (
    <View style={[styles.mainContainer, styles.elevation]}>
      ...
      <Text style={styles.paragraph}>
        GoodCollective makes visible the climate stewardship activities of individuals, and provides a direct channel of
        payment to them. We work in partnership with project developers and community organizations already providing
        climate-positive services, leveraging their impact verification approaches which correspond a steward’s
        individual activity to an intended climate outcome.
      </Text>
      ...
      <Text style={styles.paragraph}>
        ...
        activities associated with their preferred impact verification methodology to initiate direct payments to their
        stewards.
      </Text>
      <Text style={styles.subtitle}>Why we built GoodCollective</Text>
      <Text style={styles.paragraph}>
        Local communities are often the most affected by climate change. They are also the best positioned to fight it.
        As participants in microeconomic systems dependent on land and local resources, local communities are acutely
        aware both of the limit of their ecosystem and how to best steward it for inter-generational sustainability. The
        services they provide in maintaining, stewarding, and responsibly utilizing regional landscapes are critical in
      ...
      <Text style={styles.paragraph}>
        ...
        investors and nonprofit organizations to entrepreneurs and scientists – leveraging trusted, sustainable digital
        infrastructure to unlock verifiable climate action at scale. Payments and solution design provided by

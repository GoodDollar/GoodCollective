    ...
    <View>
      <View style={styles.container}>
        <TouchableOpacity style={styles.profileView}>
          <Image source={{ uri: NoAvatarIcon }} style={styles.pfp}></Image>
          <View style={styles.profileText}>
            ...
            {type == WalletProfileTypes.both && (
              <Text
                style={[
                  styles.line,
                  { color: "#959090", textDecorationLine: "underline" },
                ]}
              >
            ...
            {type == WalletProfileTypes.steward ||
              (type == WalletProfileTypes.donor && (
                <Text style={styles.line}>steward lol</Text>
              ))}
          </View>
        </TouchableOpacity>
        <View style={styles.row}>
          ...
          ></Image>
          <Text style={[styles.title, { height: 27, padding: 8 }]}>
            Impact Profile
          </Text>
        </View>
